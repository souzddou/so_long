...
/*   Updated: 2024/05/06 13:27:42 by souzddou         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	init_images(t_vars *vars)
{
	...
	vars->chars.wall = mlx_xpm_file_to_image(vars->mlx, "character/wall1.xpm",
			&img_width, &img_height);
